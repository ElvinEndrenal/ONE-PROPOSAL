...
function TeacherMain() {
  ...
  return (
    <div>
      ...
      <div id="topFunctions"><Bell/><font className="bell_profile"/><Profile className="profile"/> <font className="fontStyle1 fontColor2 occupation">TEACHER</font></div>
      <div  id="logo2">
            <img></img>
          </div>
      <div id="imgRight">
        ...
        <p className="fontStyle1 fontColor2 head head1">Hello, STI Teacher!</p>
